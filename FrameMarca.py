...
class FrameMarca(guiperfumes.FrameMarcas):
...
# Handlers for FrameMarca events.
	...
	def atualizarMarca( self, event ):
		...
		if (nome_marca): #Se o conteúdo não for vazio, faça
			...
			AcessandoBD.atualizarMarca(id_marca,nome_marca) #Chame a função para atualizar uma marca
	...
	def atualizarGrid(self):
		...
		marcas=AcessandoBD.listarMarca() #Chama a função listar marcas, retornando a lista de marcas existentes
		for marca in marcas:
